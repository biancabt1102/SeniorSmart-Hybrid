...
export default function BemVindoContent({ conteudo = null, continuacao = true }) {
  ...
  return (
    <View style={BemVindoStyles.conteudo}>
        ...
        {!!continuacao === true && <Texto style={BemVindoStyles.texto}>    Temos uma ótima notícia para você! Nosso chat bot oferece um plano mensal por apenas R$35, e um plano anual com um desconto ainda maior, por R$378. Com qualquer um dos planos, você terá acesso a todas as funcionalidades do nosso chat bot, além de suporte técnico por e-mail.
